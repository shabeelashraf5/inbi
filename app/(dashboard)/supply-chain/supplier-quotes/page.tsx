...
import { FileSearch, Clock, ShieldCheck, Mail } from 'lucide-react';
import { Separator } from '@/components/ui/separator';

type ViewMode = 'entry' | 'comparison';

// Mock active RFQ context - In a real app, this would come from a database or search params
...
export default function SupplierQuotesPage() {
  ...
  const handleSelect = (quote: SupplierProposal) => {
    ...
    // In a real app, this would pass the selected quote ID or payload
    setTimeout(() => {
       router.push('/supply-chain/quotes/new'); 
    }, 1500);
  };
  ...
  return (
    <div className="w-full space-y-12 pb-20 px-2 max-w-[1440px] animate-in fade-in duration-1000">
      ...
      {/* RFQ Context Header - Persistent Connection */}
         ...
         <div className="flex items-center gap-8">
            ...
            <div>
               <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-[11px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">{MOCK_ACTIVE_RFQ.rfqNumber}</span>
               </div>
